...
export default function GroupChatScreen({ route, navigation }) {
  ...
  const fetchGroupMessages = async () => {
    try {
      let response = await fetch(`https://message-app-qj28.onrender.com/messages/${group._id}`, {
        method: 'GET',
        headers: {
  ...
  const sendGroupMessage = async () => {
    ...
    try {
      let res = await fetch(`https://message-app-qj28.onrender.com/messages`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': user.user_id,
  ...
  const fetchGroupDetails = async () => {
    try {
      let response = await fetch(`https://message-app-qj28.onrender.com/group/${group._id}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': user.user_id,
  ...
  const searchUsers = async () => {
    ...
    try {
      let res = await fetch(`https://message-app-qj28.onrender.com/search_users?username=${encodeURIComponent(searchQuery)}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': user.user_id,
  ...
  const addUserToGroup = async (userIdToAdd) => {
    try {
      let res = await fetch(`https://message-app-qj28.onrender.com/groups/${group._id}/add_user`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': user.user_id,
  ...
  const renderSearchResult = ({ item }) => {
    return (
      <View style={styles.searchResultItem}>
        ...
        <TouchableOpacity style={styles.addButton} onPress={() => addUserToGroup(item._id ? item._id : item.id)}>
